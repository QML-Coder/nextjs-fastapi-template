# AWS Infrastructure for Next.js + FastAPI Template
# Creates EKS cluster, RDS database, CloudFront distribution, and supporting resources
...
locals {
  ...
  # Take first 3 AZs for multi-AZ deployment
...
resource "aws_s3_bucket" "frontend" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.cluster_name}-frontend-assets"
  })
}
